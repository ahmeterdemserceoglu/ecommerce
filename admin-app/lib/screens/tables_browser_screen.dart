...
class TablesBrowserScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tables Browser'),
      ),
      drawer: const AppDrawer(),
      body: Consumer<DatabaseProvider>(
        builder: (context, databaseProvider, _) {
          return FutureBuilder<List<String>>(
            future: databaseProvider.getDatabaseTables(),
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    onTap: () {
                      // You can implement table details navigation here
                    },
                  );
                },
              );
